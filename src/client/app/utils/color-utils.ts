 ...
 */
export function brighten(color: Color3, brightness: number, vibrancy = 0.5): Color3 {
 ...
 */
export function saturate(color: Color3, saturation: number): Color3 {
	const [h, s, v] = color.ToHSV();
 ...
 */
export function isBright(color: Color3): boolean {
