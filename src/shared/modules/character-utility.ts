...
import { Tag } from "shared/types/enums/tags";
...
export class CharacterUtility {
	public static getCharacterRig(user?: string): Model {
		if (user === undefined) {
	...
	public static getSpawnLocation(): CFrame {
		const spawns = CollectionService.GetTagged(Tag.SpawnLocation);
