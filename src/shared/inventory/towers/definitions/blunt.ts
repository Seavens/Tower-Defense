...
export const bluntTowerItem: ItemDefinition<ItemId.Blunt, ItemKind.Tower> = {
	...
	kind: {
		...
		upgrades: [
			{ upgrade: 1, multiplier: { damage: 0.3, range: 0.4, cooldown: -0.1 }, ability: false, cost: 300 },
			{ upgrade: 2, multiplier: { damage: 0.6, range: 0.7, cooldown: -0.2 }, ability: false, cost: 600 },
			{ upgrade: 3, multiplier: { damage: 1.2, range: 1.4, cooldown: -0.3 }, ability: false, cost: 1000 },
			{ upgrade: 4, multiplier: { damage: 1.8, range: 2.0, cooldown: -0.4 }, ability: false, cost: 1400 },
			{ upgrade: 5, multiplier: { damage: 2.5, range: 2.5, cooldown: -0.5 }, ability: false, cost: 1800 },
		],
