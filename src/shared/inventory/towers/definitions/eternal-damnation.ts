...
export const eternalDamnationTowerItem: ItemDefinition<ItemId.EternalDamnation, ItemKind.Tower> = {
	...
	kind: {
		...
		upgrades: [
			{ upgrade: 1, multiplier: { damage: 0.2, range: 0.3, cooldown: 0.92 }, ability: false, cost: 300 },
			{ upgrade: 2, multiplier: { damage: 0.4, range: 0.5, cooldown: 0.86 }, ability: false, cost: 500 },
			{ upgrade: 3, multiplier: { damage: 0.8, range: 0.9, cooldown: 0.82 }, ability: false, cost: 700 },
			{ upgrade: 4, multiplier: { damage: 1.3, range: 1.2, cooldown: 0.79 }, ability: false, cost: 900 },
			{ upgrade: 5, multiplier: { damage: 1.9, range: 1.5, cooldown: 0.75 }, ability: false, cost: 1900 },
			{ upgrade: 6, multiplier: { damage: 2.6, range: 1.7, cooldown: 0.72 }, ability: false, cost: 2600 },
			{ upgrade: 7, multiplier: { damage: 3.4, range: 2.1, cooldown: 0.68 }, ability: false, cost: 3400 },
			{ upgrade: 8, multiplier: { damage: 4.3, range: 2.5, cooldown: 0.65 }, ability: true, cost: 4300 },
			{ upgrade: 9, multiplier: { damage: 5.3, range: 3, cooldown: 0.62 }, ability: true, cost: 5300 },
			{ upgrade: 10, multiplier: { damage: 6.4, range: 3.5, cooldown: 0.59 }, ability: true, cost: 6400 },
		],
		...
		visuals: {
			[TowerVisuals.Summon]: TowerVisual.EDSummon,
