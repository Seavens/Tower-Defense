...
export const testMap: MapDefinition<MapId.Test> = {
	...
	waves: [
		...
		{
			[MobId.Zombie]: { count: 10, delay: 5, wait: 0.5, reward: 500 },
		},
		{
			[MobId.Zombie]: { count: 15, delay: 5, wait: 0.3, reward: 500 },
		},
		{
			[MobId.Zombie]: { count: 25, delay: 5, wait: 0.3, reward: 500 },
		},
		{
			[MobId.Zombie]: { count: 35, delay: 5, wait: 0.3, reward: 500 },
		},
	],
