...
import type { AttackId } from "shared/types/ids/attack-id";
import type { DamageKind } from "shared/types/kinds/damage-kind";
import type { TowerId } from "shared/types/ids/tower-id";
